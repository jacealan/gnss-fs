...
export default function EventPlDs() {
  ...
  return (
    <Box>
      <Box>
        <Image src="/assets/events/PlDs1.png" alt=""></Image>
      </Box>
      <Box>
        <Link href="https://forms.gle/WVer6uWKgRJmRUAV6" target="_blank">
          <Image src="/assets/events/PlDs2.png" alt=""></Image>
        </Link>
      </Box>
      <Box>
        <Image src="/assets/events/PlDs3.png" alt=""></Image>
      </Box>
      <Box>
        <Link href="https://forms.gle/bzJc6SeyJ8UsW6eGA" target="_blank">
          <Image src="/assets/events/PlDs4.png" alt=""></Image>
        </Link>
      </Box>
      {/* <Box>
      ...
      <Box width="100%">
        <Image src="/assets/events/loc.png" alt=""></Image>
        {/* <Link
